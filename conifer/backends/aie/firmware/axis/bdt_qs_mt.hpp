...
// The ladder is generated per project (roles.py). A tile's tree range is baked into its
// symbol, so the enumeration is unavoidable; writing it out by hand is what made 64 a
// ceiling this device does not have.
